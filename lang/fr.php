<?php    
	...
	'L_UPDATE_NGINX_CONF'		=> 'Le plugin est compatible NGINX en éditant le fichier de configuration de votre serveur.
	Si vous hébergez plusieurs site sur le même hébergement, n\'éditez que le fichier correspondant au site où vous installez le plugin.
...
Ces lignes sont :<pre style="color: fuchsia;font-weight: bold;">
	...
	'L_FORCED_EXTENSION'		=> 'Extension de fichiers en téléchargement forcé : ',
	'L_EXTENSION'				=> 'Extensions de fichier à traiter et à forcer au téléchargement',
	'L_FORMAT_WARNING' 			=> 'Insérer les extensions de fichier en les séparant par une barre oblique : | et sans espaces.',
	...
	'L_NO_DATA'					=> 'Aucun fichier téléchargé.',
	'L_FILE'					=> 'Fichier(s)',
